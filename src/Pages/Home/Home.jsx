...
const Home = () => {
    ...
    return (
        <div className='w-[85%] mx-auto mt-7 md:grid md:grid-cols-2 flex flex-col-reverse md:flex-row md:justify-between items-center'>
                ...
                <div className='relative'> 
                        <div className='w-32 mt-12 grid place-items-center'>
                            ...
                            <aside className='flex items-center justify-center icon-style cursor-pointer'>
                                ...
                                <div className="icon"><GoArrowRight className='aboslute text-white text-2xl'/></div>
                            </aside>
                        </div>     
                </div>
                </a>
